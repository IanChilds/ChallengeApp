...
public class AddUser extends AsyncTask<String, Void, Boolean> {
    ...
    protected Boolean doInBackground(String... params) {
        ...
        try{
            ...
            String url = "http://alpine-avatar-381.appspot.com/addUser?user=" + params[0];
  //          URI uri = URIUtils.createURI("http", "alpine-avatar-381.appspot.com", -1, "/addUser?user=" + params[0],
